...
public class ODKDatabaseImplUtils {
   ...
   * @return
   */
  public OrderedColumns getUserDefinedColumns(SQLiteDatabase db, String appName, String tableId) {
   ...
   */
  public OrderedColumns createOrOpenDBTableWithColumns(SQLiteDatabase db,
