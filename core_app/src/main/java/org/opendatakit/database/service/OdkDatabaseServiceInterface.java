...
public class OdkDatabaseServiceInterface extends OdkDbInterface.Stub {
  ...
  @Override
  public void serverTableSchemaETagChanged(String appName, OdkDbHandle dbHandleName, String tableId,
      String schemaETag, String tableInstanceFilesUri) throws RemoteException {
    ...
    try {
      ...
      ODKDatabaseImplUtils.get()
          .serverTableSchemaETagChanged(db, tableId, schemaETag, tableInstanceFilesUri);
    } catch (Exception e) {
      String msg = e.getLocalizedMessage();
      if (msg == null)
        msg = e.getMessage();
  ...
  @Override
  public OdkDbChunk createOrOpenDBTableWithColumns(String appName, OdkDbHandle dbHandleName,
  ...
  @Override
  public OdkDbChunk createOrOpenDBTableWithColumnsAndProperties(String appName,
  ...
  @Override
  public OdkDbChunk deleteAllCheckpointRowsWithId(String appName, OdkDbHandle dbHandleName,
  ...
  @Override
  public OdkDbChunk deleteLastCheckpointRowWithId(String appName, OdkDbHandle dbHandleName,
      String tableId, OrderedColumns orderedDefns, String rowId) throws RemoteException {
  ...
  @Override
  public OdkDbChunk deleteRowWithId(String appName, OdkDbHandle dbHandleName, String tableId,
    ...
    try {
      ...
      msg = "Exception: " + msg;
      WebLogger.getLogger(appName)
          .e("deleteRowWithId", appName + " " + dbHandleName.getDatabaseHandle() + " " + msg);
      WebLogger.getLogger(appName).printStackTrace(e);
      throw new RemoteException(msg);
    } finally {
      if (db != null) {
  ...
  @Override
  public OdkDbChunk getAdminColumns() throws RemoteException {
  ...
  @Override
  public OdkDbChunk getAllColumnNames(String appName, OdkDbHandle dbHandleName, String tableId)
      throws RemoteException {
  ...
  @Override
  public OdkDbChunk getAllTableIds(String appName, OdkDbHandle dbHandleName)
      throws RemoteException {
  ...
  @Override
  public OdkDbChunk getRowsWithId(String appName, OdkDbHandle dbHandleName, String tableId,
      OrderedColumns orderedDefns, String rowId) throws RemoteException {
    ...
    try {
      ...
      msg = "Exception: " + msg;
      WebLogger.getLogger(appName)
          .e("getRowsWithId", appName + " " + dbHandleName.getDatabaseHandle() + " " + msg);
      WebLogger.getLogger(appName).printStackTrace(e);
      throw new RemoteException(msg);
    } finally {
      if (db != null) {
  ...
  @Override
  public OdkDbChunk getMostRecentRowWithId(String appName, OdkDbHandle dbHandleName, String tableId,
      OrderedColumns orderedDefns, String rowId) throws RemoteException {
  ...
  @Override
  public OdkDbChunk getDBTableMetadata(String appName, OdkDbHandle dbHandleName, String tableId,
      String partition, String aspect, String key) throws RemoteException {
  ...
  @Override
  public OdkDbChunk getTableHealthStatuses(String appName, OdkDbHandle dbHandleName)
      throws RemoteException {
  ...
  @Override
  public OdkDbChunk getExportColumns() throws RemoteException {
  ...
  @Override
  public OdkDbChunk getTableDefinitionEntry(String appName, OdkDbHandle dbHandleName,
  ...
  @Override
  public OdkDbChunk getUserDefinedColumns(String appName, OdkDbHandle dbHandleName, String tableId)
      throws RemoteException {
  ...
  @Override
  public OdkDbChunk insertCheckpointRowWithId(String appName, OdkDbHandle dbHandleName,
  ...
  @Override
  public OdkDbChunk insertRowWithId(String appName, OdkDbHandle dbHandleName, String tableId,
    ...
    try {
      ...
      msg = "Exception: " + msg;
      WebLogger.getLogger(appName)
          .e("insertRowWithId", appName + " " + dbHandleName.getDatabaseHandle() + " " + msg);
      WebLogger.getLogger(appName).printStackTrace(e);
      throw new RemoteException(msg);
    } finally {
      if (db != null) {
  ...
  @Override
  public OdkDbChunk placeRowIntoServerConflictWithId(String appName, OdkDbHandle dbHandleName,
      String tableId, OrderedColumns orderedColumns, ContentValues cvValues, String rowId,
    ...
    try {
      ...
      ODKDatabaseImplUtils.get()
          .placeRowIntoServerConflictWithId(db, tableId, orderedColumns, cvValues, rowId,
              localRowConflictType);
      UserTable t = ODKDatabaseImplUtils.get()
          .getConflictingRowsInExistingDBTableWithId(db, appName, tableId, orderedColumns, rowId);
      db.setTransactionSuccessful();
      return getAndCacheChunks(t);
    } catch (Exception e) {
      String msg = e.getLocalizedMessage();
  ...
  @Override
  public OdkDbChunk rawSqlQuery(String appName, OdkDbHandle dbHandleName, String tableId,
  ...
  @Override
  public OdkDbChunk saveAsIncompleteMostRecentCheckpointRowWithId(String appName,
  ...
  @Override
  public OdkDbChunk saveAsCompleteMostRecentCheckpointRowWithId(String appName,
      OdkDbHandle dbHandleName, String tableId, OrderedColumns orderedColumns,
      ContentValues cvValues, String rowId) throws RemoteException {
  ...
  @Override
  public OdkDbChunk updateRowWithId(String appName, OdkDbHandle dbHandleName, String tableId,
      OrderedColumns orderedColumns, ContentValues cvValues, String rowId) throws RemoteException {
    ...
    try {
      ...
      db = OdkConnectionFactorySingleton.getOdkConnectionFactoryInterface()
          .getConnection(appName, dbHandleName);
      db.beginTransactionExclusive();
      ODKDatabaseImplUtils.get().updateRowWithId(db, tableId, orderedColumns, cvValues, rowId);
      UserTable t = ODKDatabaseImplUtils.get()
          .getMostRecentRowWithId(db, appName, tableId, orderedColumns, rowId);
      db.setTransactionSuccessful();
      return getAndCacheChunks(t);
      ...
      msg = "Exception: " + msg;
      WebLogger.getLogger(appName)
          .e("updateRowWithId", appName + " " + dbHandleName.getDatabaseHandle() + " " + msg);
      WebLogger.getLogger(appName).printStackTrace(e);
      throw new RemoteException(msg);
    } finally {
      if (db != null) {
  ...
  @Override
  public void deleteAllSyncETagsForTableId(String appName, OdkDbHandle dbHandleName, String tableId)
      throws RemoteException {
  ...
  @Override
  public void updateManifestSyncETag(String appName, OdkDbHandle dbHandleName, String verifiedUri,
      String tableId, String eTag) throws RemoteException {
  ...
  @Override
  public OdkDbChunk getChunk(ParcelUuid chunkID) {
