...
public class CheckpointResolutionRowFragment extends ListFragment implements
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    ...
    mAdapter = new ConflictResolutionColumnListAdapter(getActivity(), mAppName, this);
  ...
  public Loader<ResolveActionList> onCreateLoader(int id, Bundle args) {
    ...
    return new OdkResolveFieldLoader(getActivity(), mAppName, mTableId, mRowId);
  }
  ...
  public void onLoadFinished(Loader<ResolveActionList> loader,
    ...
    mAdapter.clear();
    if ( resolveFieldEntryArrayList.conflictColumns.isEmpty() ){
    ...
    this.mButtonTakeNewestWithDeltas
