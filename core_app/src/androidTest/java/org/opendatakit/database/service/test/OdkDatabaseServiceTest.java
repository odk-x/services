...
public class OdkDatabaseServiceTest extends ServiceTestCase<OdkDatabaseService> {
  ...
  public void testDbInsertSingleRowIntoTable() {
    ...
    try {
      ...
      serviceInterface.insertRowWithId(APPNAME, db, DB_TABLE_ID, columns, contentValuesTestSet1(),
          rowId.toString());
  ...
  public void testDbInsertTwoRowsIntoTable() {
    ...
    try {
      ...
      serviceInterface.insertRowWithId(APPNAME, db, DB_TABLE_ID, columns, contentValuesTestSet1(),
          rowId1.toString());
      serviceInterface.insertRowWithId(APPNAME, db, DB_TABLE_ID, columns, contentValuesTestSet2(),
          rowId2.toString());
  ...
  */
  public void testDbUpdateAllValues() {
    ...
    try {
      ...
      serviceInterface.updateRowWithId(APPNAME, db, DB_TABLE_ID, columns, contentValuesTestSet2(),
          rowId.toString());
  ...
  public void testDbUpdateSingleValue() {
    ...
    try {
      ...
      serviceInterface
          .updateRowWithId(APPNAME, db, DB_TABLE_ID, singleColumn, singleValue, rowId.toString());
  ...
  public void testDbUpdateWTwoServiceConnections() {
    ...
    try {
      ...
      Log.i("openDatabase", "testDbUpdateWTwoServiceConnections db1: " + db1.getDatabaseHandle());

      OdkDbHandle db2 = serviceInterface2.openDatabase(APPNAME);
      Log.i("openDatabase", "testDbUpdateWTwoServiceConnections db2: " + db2.getDatabaseHandle());

      serviceInterface1.createOrOpenDBTableWithColumns(APPNAME, db1, DB_TABLE_ID, colList);

      serviceInterface1.insertRowWithId(APPNAME, db1, DB_TABLE_ID, columns, contentValuesTestSet1(),
          rowId.toString());
      ...
      serviceInterface2.updateRowWithId(APPNAME, db2, DB_TABLE_ID, columns, contentValuesTestSet2(),
          rowId.toString());
