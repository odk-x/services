...
public class OdkDatabaseTypesTest extends OdkDatabaseTestAbstractBase {
   ...
   private static final String COL_OBJ_ID = "columnObject";
   ...
   @NonNull private List<Column> createColumnList() {
      ...
      columns.add(new Column(COL_CONFIGPATH_ID, "column Configpath", ElementDataType.configpath
          .name
          (), null));
 //     columns.add(new Column(COL_ARRAY_ID, "column Array", ElementDataType.array.name(), null));
      columns.add(new Column(COL_STRING_ID, "column String", ElementDataType.string.name(),
          null));
  //    columns.add(new Column(COL_OBJ_ID, "column Object", ElementDataType.object.name(),null));
 ...
 //     assertNull(row.getDataByKey(COL_ARRAY_ID));
  ...
  //    assertNull(row.getDataByKey(COL_OBJ_ID));
   }
   ...
   private void verifyRowTestSeti(TypedRow row, int i) {
     ...
     // assertEquals(row.getDataByKey(COL_ARRAY_ID), ???);
      assertEquals(row.getDataByKey(COL_STRING_ID), TEST_STR_i + i);
     // assertEquals(row.getDataByKey(COL_OBJ_ID), ???);
   }
