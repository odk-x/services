...
import org.opendatakit.services.database.AndroidConvConnectFactory;
...
public class AbstractPermissionsTestCase extends AndroidTestCase {
  ...
  protected static final DbHandle uniqueKey = new DbHandle(AbstractPermissionsTestCase.class.getSimpleName() + AndroidConvConnectFactory.INTERNAL_TYPE_SUFFIX);
...
*/
  ...
  protected synchronized void setUp() throws Exception {
    ...
    db = OdkConnectionFactorySingleton
        .getOdkConnectionFactoryInterface().getConnection(getAppName(), uniqueKey, getContext());
    if ( beganUninitialized ) {
      // start clean
