...
public class AndroidOdkConnection1 implements OdkConnectionInterface {
  final Object mutex;
  /**
  ...
  public static AndroidOdkConnection1 openDatabase(
    ...
    try {
      ...
      AndroidOdkConnection1 connection = new AndroidOdkConnection1(
  ...
  private AndroidOdkConnection1(Object mutex, String appName, OperationLog operationLog,
  ...
  public boolean waitForInitializationComplete() {
    for (; ; ) {
      ...
      WebLogger.getLogger(appName).i("AndroidOdkConnection1",
  ...
  private String getLogTag() {
    return "AndroidOdkConnection1:" + appName + ":" + sessionQualifier;
  }
    ...
    try {
      ...
      if (refCount != 0) {
        WebLogger.getLogger(appName).e(getLogTag(),
            "An AndroidOdkConnection1 object for database '" + appName + "' sessionQualifier '"
  ...
  public void beginTransactionExclusive() throws SQLException {
    ...
    if (!success) {
      WebLogger.getLogger(appName)
          .e("AndroidOdkConnection1", "Attempting dump of all database connections");
