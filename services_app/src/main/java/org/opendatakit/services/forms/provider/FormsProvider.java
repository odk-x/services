...
public class FormsProvider extends ContentProvider {
  ...
  public synchronized Uri insert(@NonNull Uri uri, ContentValues initialValues) {
    ...
    try {
      ...
      db = OdkConnectionFactorySingleton.getOdkConnectionFactoryInterface().getConnection(appName, dbHandleName, getContext());
  ...
  public Cursor query(@NonNull Uri uri, String[] projection, String where, String[] whereArgs,
    ...
    try {
      // +1 referenceCount if db is returned (non-null)
      db = OdkConnectionFactorySingleton.getOdkConnectionFactoryInterface().getConnection(pf.appName, dbHandleName, getContext());
