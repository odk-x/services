 ...
 */
public abstract class AuthenticationFragment extends Fragment implements ISyncOutcomeHandler {

   private static final String TAG = "AuthenticationFragment";

   public static final String NAME = "AuthenticationFragment";

   protected static final String ACCOUNT_TYPE_G = "com.google";

   protected static final String VERIFY_SERVER_SETTINGS_ACTION = "verifyServerSettingsAction";

   protected static final String PROGRESS_DIALOG_TAG = "progressDialog";

   protected static final String OUTCOME_DIALOG_TAG = "outcomeDialog";

   protected String mAppName;

   protected final Handler handler = new Handler();
   protected DismissableProgressDialogFragment progressDialog = null;
   protected DismissableOutcomeDialogFragment outcomeDialog = null;

   protected TextView uriField;
   protected TextView accountAuthType;
   protected TextView accountIdentity;

   protected VerifyServerSettingsActions verifyServerSettingsAction =
       VerifyServerSettingsActions.IDLE;
