...
public class AdminPasswordChallengeActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    boolean mAdminConfigured = adminPwd != null && !adminPwd.isEmpty();
    ...
    positiveButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        TextView passwordEditText = (TextView) findViewById(R.id.pwd_field);
        ...
        if (adminPwd.equals(pw)) {
          ...
          Toast.makeText(AdminPasswordChallengeActivity.this, R.string.password_mismatch,
              Toast.LENGTH_SHORT).show();
        }
      }
    });

    View negativeButton = findViewById(R.id.negative_button);
