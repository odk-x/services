...
public class ODKDatabaseImplUtils {
   ...
   * @return
   */
  public UserTable getMostRecentRowWithId(OdkConnectionInterface db, String appName, String tableId,
      OrderedColumns orderedDefns, String rowId) {
  ...
  public UserTable getConflictingRowsInExistingDBTableWithId(OdkConnectionInterface db,
      String appName, String tableId, OrderedColumns orderedDefns, String rowId) {
    ...
    for (int i = 0; i < table.getNumberOfRows(); ++i) {
      if (table.getRowAtIndex(i).getRawDataOrMetadataByElementKey(DataTableColumns.CONFLICT_TYPE)
          == null) {
  ...
  public void resolveServerConflictTakeLocalRowWithId(OdkConnectionInterface db, String appName,
    ...
    try {
      ...
      int localConflictType = Integer
          .parseInt(localRow.getRawDataOrMetadataByElementKey(DataTableColumns.CONFLICT_TYPE));

      int serverConflictType = Integer
          .parseInt(serverRow.getRawDataOrMetadataByElementKey(DataTableColumns.CONFLICT_TYPE));
